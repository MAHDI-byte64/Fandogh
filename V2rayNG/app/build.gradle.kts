...
android {
    // NOTE: namespace must stay com.v2ray.ang — the native hev-socks5-tunnel
    // library is compiled with -DPKGNAME=com/v2ray/ang/service, so renaming the
    // package here breaks JNI registration at runtime. Only applicationId and
    // the display name are rebranded.
        ...
        if (isFdroid) {
            ...
            variant.outputs
                ...
                .forEach { output ->
                    ...
                    output.outputFileName = "Fandogh_${variant.versionName}-fdroid_${abi}.apk"
            ...
            variant.outputs
                ...
                .forEach { output ->
                    ...
                    output.outputFileName = "Fandogh_${variant.versionName}_${abi}.apk"
                    if (versionCodes.containsKey(abi)) {
                        output.versionCodeOverride =
